...
class Str {
  ...
  static String get team1Label => 'Red';
  static String get team2Label => 'Black';
  static String get winMessage => '{{team}} team wins!';
  static String get newGameButton => 'New Game';
  static String get settingsScoring => 'Track team scores';
  static String get correctScore => 'Adjust {{team}} score';
  static String get resetConfirmation => 'Reset suit and scores?';
  static String get cancelButton => 'Cancel';
  static String get resetButton => 'Reset';
